...
export type InsertUserMutation = { __typename?: 'mutation_root', insert_users_one?: Maybe<{ __typename?: 'users', created_at: any, id: number, name: string, profile_photo_url: string, updated_at: any }> };
...
/**
 * __useSelectUserByIdQuery__
 *
 * To run a query within a React component, call `useSelectUserByIdQuery` and pass it any options that fit your needs.
 * When your component renders, `useSelectUserByIdQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useSelectUserByIdQuery({
 *   variables: {
 *      id: // value for 'id'
 *   },
 * });
 */
export function useSelectUserByIdQuery(baseOptions: Apollo.QueryHookOptions<SelectUserByIdQuery, SelectUserByIdQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<SelectUserByIdQuery, SelectUserByIdQueryVariables>(SelectUserByIdDocument, options);
      }
export function useSelectUserByIdLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<SelectUserByIdQuery, SelectUserByIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<SelectUserByIdQuery, SelectUserByIdQueryVariables>(SelectUserByIdDocument, options);
        }
export type SelectUserByIdQueryHookResult = ReturnType<typeof useSelectUserByIdQuery>;
export type SelectUserByIdLazyQueryHookResult = ReturnType<typeof useSelectUserByIdLazyQuery>;
export type SelectUserByIdQueryResult = Apollo.QueryResult<SelectUserByIdQuery, SelectUserByIdQueryVariables>;